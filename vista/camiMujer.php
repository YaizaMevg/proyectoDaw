...
<br>      
        <div class="row small-up-2 medium-up-3 large-up-4">
          ...
          $sentencia = "select nomProducto,imagenProducto from t_producto where idCategoria=1 and idTipoP=2";
          $consulta = mysqli_query($connexio, $sentencia);
            while($row = mysqli_fetch_array($consulta))
            {
            ?>
            <div class="column">
                <a href="producto1.php"><img class="thumbnail" src="<?php echo $row["imagenProducto"];?>"></a>
